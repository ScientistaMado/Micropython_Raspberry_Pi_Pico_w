...
def show_led_menu():
    ...
    if blue_led.value():
        oled.blit(menu_extras.openIcon("led_on_2"), 75, 16)
    else:
        oled.blit(menu_extras.openIcon("led_off_2"), 75, 16)

    if red_led.value():
        oled.blit(menu_extras.openIcon("led_on_2"), 98, 16)
    else:
        oled.blit(menu_extras.openIcon("led_off_2"), 98, 16)
